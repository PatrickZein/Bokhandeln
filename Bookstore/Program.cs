...
namespace Bookstore
{
    class Program
    {
            ...
            while (!searchString.Equals(""))
            {
                ...
                if (!searchString.Equals(""))
                {
                    ...
                    foreach (Book bokObjekt in boklista.Result)
                    {
                        ...
                        {
                            Console.WriteLine("Totalt antal bokobjekt i 'databasen': " + bokObjekt.Counter);
                        }
                        else {
        ...
        static async Task<IEnumerable<Book>> BookSearchAsync(string searchString, int startCount, int maxCount)
        {
            ...
            bookSelection.Add(new Book(count, "count", "", 0, 0));

            return bookSelection;
        }

        public void OrderBook(Book book, int copies)
        {
            //###
        }
